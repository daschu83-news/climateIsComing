...
3. Assign the API key as (new?) organization secret or edit it at https://github.com/organizations/daschu83-news/settings/secrets/actions  
   * Name:  **RAPIDAPI_KEY**   
   * Value: **Your key here**   
...
:no_entry: News-API-14 status **failed**:  
